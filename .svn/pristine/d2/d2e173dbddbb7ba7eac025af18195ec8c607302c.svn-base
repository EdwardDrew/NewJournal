...
public class SimpleBackActivity extends KJActivity
{
	...
	@ BindView( id = R.id.rl_search_title ) 
	protected RelativeLayout mRelativeLayoutSearch; //搜索标题栏
	@ BindView( id = R.id.titlebar_img_back_search, click = true )
	protected ImageView mImgBackSearch; // 搜索标题栏返回图标
	...
	public void widgetClick( View v )
	{
		...
		case R.id.titlebar_img_back_search :
			onBackClick();
			break;
	...
	public void setRLSearchVisible( int vi ){
		if (mRelativeLayout != null) {
			mRelativeLayoutSearch.setVisibility( vi );
		}
	}
	...
	* @date 2015年10月26日
	*/
	public void setBackImageSearch( int resId )
	{
		if ( mImgBackSearch != null )
		{
			mImgBackSearch.setImageResource( resId );
		}
		else
		{
			mImgBackSearch = (ImageView) findViewById( resId );
			mImgBackSearch.setOnClickListener( this );
		}
	}
