...
public class ResideMenu extends FrameLayout
{
	...
	private void initViews( Context context )
	{
		...
		leftMenu = (LinearLayout) findViewById( R.id.rl_left_menu );
		rightMenu = (LinearLayout) findViewById( R.id.rl_right_menu );
	...
	public void openMenu( int direction )
	{
		...
		AnimatorSet scaleDown_shadow = buildScaleDownAnimation(
				imageViewShadow, mScaleValue + shadowAdjustScaleX, mScaleValue
						+ shadowAdjustScaleY );
	...
	private void setScaleDirection( int direction )
	{
		...
		if ( direction == DIRECTION_LEFT )
		{
			...
			pivotX = screenWidth * 1.85f; //内容区域中心x轴移动的距离
		}
		else
		{
